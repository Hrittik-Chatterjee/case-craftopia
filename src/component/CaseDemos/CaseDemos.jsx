        ...
        <div className="flex h-screen my-12 bg-slate-600 rounded-xl ">
          ...
          <div className=" flex-auto  w-8 p-5 sticky top-0  bg-black rounded-xl justify-center items-center hidden md:block lg:block">
            <div className="bg-warning p-20 shadow-md rounded-lg">
              ...
              <p className=" mt-4">
                Unlock your creativity and make your phone truly your own with
                our custom phone case creation tool. With endless possibilities
                at your fingertips create a one-of-a-kind design from scratch,
                our intuitive customization platform makes it easy. Choose from
                a variety of case types, colors, and materials, and let your
                imagination run wild. Whether you are looking for a thoughtful
                gift or want to treat yourself to something special, our custom
                phone cases are the perfect way to stand out from the crowd and
                make a statement. Start designing your masterpiece today and
          ...
          <div className="no-scrollbar w-1/2 flex-1 overflow-y-scroll p-20">
            ...
            <div className="md:bg-warning lg:bg-warning md:p-20 ld:p-20 shadow-md rounded-lg">
              <p className="text-sm  font-semibold hidden md:block sm:block">
                Create Your Own Imangination or Keep your catured memories
                always with you
              </p>
